...
?>
  <!-- เนื้อหา(content) -->
    ...
    <?php
      ...
      $sqlpro = "SELECT*FROM pro_product where pro_category_id='2'  limit {$start} , {$perpage}";
    ...
    <div class="pagination">
        <a href="pro-v-t-shirt.php?page=1" aria-label="Previous">
          <span aria-hidden="true">&laquo;</span>
        </a>
        <?php for($i=1;$i<=$total_page;$i++) { ?>
        <a href="pro-v-t-shirt.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
        <?php } ?>
        <a href="pro-v-t-shirt.php?page=<?php echo $total_page;?>" aria-label="Next">
    ...
    <div class="rowsor w3-content w3-row-padding">
          ...
          <?php 
            if(!$row) {
                echo "<div class='w3-center' style='padding-top:150px;'>";
                    echo "<i>ยังไม่มีสินค้าในรายการนี้.</i>";
                echo "</div>";
            }
          ?>
    </div>
